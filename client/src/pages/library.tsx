  ...
  const renameMutation = useMutation({
    ...
    onSuccess: (updated) => {
      queryClient.setQueryData<Project[]>(['/api/projects'], (old) =>
        old?.map((project) => (project.id === updated.id ? updated : project)) ?? [updated],
      );
      queryClient.setQueryData(['/api/projects', updated.id], updated);
      toast({
        title: "Title updated",
        description: "Project name saved.",
      });
    },
    onError: () => {
      toast({
        title: "Failed to rename",
        description: "Could not update the project title. Please try again.",
        variant: "destructive",
      });
    },
  });
