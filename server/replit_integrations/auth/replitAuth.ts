...
import type { Strategy as StrategyType, VerifyFunction } from "openid-client/passport";
...
export async function setupAuth(app: Express) {
  ...
  // Skip Replit OAuth in local development
  if (process.env.REPL_ID === 'local-dev') {
    ...
    // Add dummy login routes for local dev
